...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto">
        ...
        <!-- Form Card -->
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden transform transition-all hover:scale-[1.01]">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <select name="role" id="role" required
                                class="mt-1 block w-full pl-3 pr-10 py-2 text-base border border-gray-300 dark:border-gray-600
